...
// Post ADR-0161 migration: was '../../../agentdb/src/config/embedding-config.js'
// (workspace-relative path into agentic-flow's vendored copy); now imports
// from the npm-published artifact since agentdb-onnx lives alongside agentdb
// in forks/agentdb/packages/. Codemod's UNSCOPED_MAP rewrites bare
// 'agentdb' → '@sparkleideas/agentdb' at publish time.
